...
class SettlementCalculatorTest {
    ...
    void 필수시나리오_creator1_2025_03_정산() {
        ...
        SettlementResult result = SettlementCalculator.calculate(260_000L, 110_000L, 20L);
    ...
    void 판매없고_환불없으면_전부_0() {
        SettlementResult result = SettlementCalculator.calculate(0L, 0L, 20L);
    ...
    void 수수료율_20퍼센트_정확히_적용() {
        SettlementResult result = SettlementCalculator.calculate(100_000L, 0L, 20L);
    ...
    void 부분환불_순매출에_잔여금액_남음() {
        ...
        SettlementResult result = SettlementCalculator.calculate(80_000L, 30_000L, 20L);
